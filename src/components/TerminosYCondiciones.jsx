        ...
        <div className="min-h-screen bg-black text-gray-300 font-sans pt-24 pb-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-gray-900/50 p-8 rounded-2xl border border-white/10 shadow-2xl backdrop-blur-sm">
                ...
                <div className="space-y-6 text-sm md:text-base leading-relaxed">
                    <section>
                        <h2 className="text-xl font-bold text-white mb-2">Senior Robot</h2>
                        <p className="text-gray-400">21 de noviembre de 2025</p>
                        <h3 className="text-lg font-bold text-emerald-500 mt-4 mb-2">Bienvenido a Senior Robot</h3>
                        <p>
                    ...
                    <section>
                        ...
                        <p>
                            Senior Robot ofrece herramientas de software para la automatización de respuestas, gestión de flujos de conversación y chatbots a través de la plataforma WhatsApp (”el Servicio”), diseñado para optimizar la comunicación de microempresas.
                        </p>
                        <p className="mt-2">
                    ...
                    <section>
                        ...
                        <p>
                            El Usuario reconoce que Senior Robot es una herramienta independiente y no está afiliada, asociada, autorizada, respaldada ni conectada oficialmente de ninguna manera con WhatsApp Inc. o Meta Platforms, Inc.
                        </p>
                        ...
                        <p className="mt-2">
                            Senior Robot no se hace responsable de bloqueos, suspensiones o inhabilitaciones de números telefónicos por parte de WhatsApp debido al mal uso de la plataforma o incumplimiento de sus políticas por parte del Usuario.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            Todo el contenido, software, código fuente, diseños, logotipos y marcas comerciales relacionados con Senior Robot son propiedad exclusiva de nosotros o de nuestros licenciantes. Se prohíbe la reproducción, distribución o ingeniería inversa de nuestra plataforma sin autorización expresa.
                        </p>
                    </section>

                    <section>
                        <h3 className="text-lg font-bold text-emerald-500 mb-2">6. LIMITACIÓN DE RESPONSABILIDAD</h3>
                        <p>En la máxima medida permitida por la ley aplicable, Senior Robot no será responsable por:</p>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 mt-2 space-y-1">
                            <li><strong>Correo electrónico:</strong> contacto@senior-robot.com</li>
