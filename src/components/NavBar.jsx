...
const NavBar = () => {
  ...
  return (
    <nav className="sticky top-0 z-30 bg-[#0a0a0a] shadow-md border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <a href="#inicio" className="flex items-center space-x-3 flex-shrink-0">
            ...
            />
            <span className="text-xl sm:text-3xl font-extrabold text-white">Mr-Robot</span>
          </a>
          ...
          <div className="md:hidden">
            <button
              ...
              type="button"
              className="text-gray-300 hover:text-whatsapp-green focus:outline-none focus:text-whatsapp-green transition duration-150 ease-in-out"
          ...
          <ul className="hidden md:flex space-x-6 sm:space-x-8">
            ...
            <li>
              <a
                href="#conoceme"
                className="text-base text-gray-300 font-regular hover:text-whatsapp-green transition duration-200"
              >
                Conóceme
              </a>
            </li>
      ...
      >
        <ul className="px-2 pt-2 pb-3 space-y-1 sm:px-3 text-center bg-[#0a0a0a] border-t border-gray-800">
          <li>
            <a
              href="#inicio"
          ...
          <li>
            <a
              href="#conoceme"
              onClick={handleNavLinkClick}
              className="block py-2 text-sm text-gray-300 font-regular hover:text-whatsapp-green transition duration-200"
            >
              Conóceme
            </a>
          </li>
